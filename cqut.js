...
window.CQUT_MATCHES = [
  /* ===== 材料科学与工程学院（对口的那个） ===== */
  {n:"“大龙杯”第六届全国大学生高分子材料实验实践大赛校内选拔赛顺利完成", org:"材料科学与工程学院", lv:"国家级",
   st:"已结束 · 校内选拔已完成", date:"2026-06-26", tag:"mat", fit:1,
   intro:"【本条是获奖结果报道，不是报名入口】全国高分子材料专业的实验技能擂台。学校由材料科学与工程学院高分子材料与工程系牵头组织，2026 年 3–6 月完成校内选拔，面向 2023/2024 级高分子材料与工程专业全体学生。",
  ...
  {n:"学院在第四届重庆市大学生金相技能大赛中斩获佳绩", org:"材料科学与工程学院", lv:"国家级 / 省部级",
   st:"已结束 · 出成绩", date:"2026-05-25", tag:"mat", fit:1,
   intro:"【本条是获奖结果报道，不是报名入口】金相制样技能的比赛。由重庆市教育委员会指导，重庆科技大学承办，来自重庆大学、西南大学、重庆交通大学等 16 所本专科院校的 144 名选手参赛。学校由材料学院牵头组织选拔与集训。",
  ...
  /* ===== 机械工程学院 ===== */
  {n:"[喜讯]我院学子在第二十一届全国大学生智能汽车竞赛中荣获二等奖", org:"机械工程学院", lv:"国家级",
   st:"已结束 · 我校获全国二等奖", date:"2026-08-27", tag:"mech", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】全国高校智能车/电控类顶级赛事。学校由机械工程学院组队，本条记录为总决赛二等奖。",
  ...
  {n:"[喜讯]我院学子在全国大学生机器人大赛RoboMaster2026机甲大师赛中斩获一等奖", org:"机械工程学院", lv:"国家级",
   st:"已结束 · 我校获全国一等奖", date:"2026-08-27", tag:"mech", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】RoboMaster 是 Robot 界的全国联赛，学校由机械工程学院参赛，本条记录为全国一等奖。",
  ...
  {n:"[喜讯]我院学子在中国大学生机械工程创新创意大赛全国总决赛中斩获一等奖", org:"机械工程学院", lv:"国家级",
   st:"已结束 · 我校获全国一等奖", date:"2026-08-27", tag:"mech", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】面向机械类专业的全国性创新创意赛事，学校参赛队在总决赛中斩获一等奖。",
  ...
  {n:"[喜讯]学院参赛团队在2026年全国大学生物联网设计竞赛总决赛中斩获一等奖", org:"机械工程学院", lv:"国家级",
   st:"已结束 · 我校获全国一等奖", date:"2026-08-27", tag:"mech", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】物联网设计类的全国性赛事，学校参赛团队在总决赛中斩获一等奖。",
  ...
  {n:"[喜讯]我院学子在第十二届全国大学生机械创新设计大赛（2026）中荣获一等奖", org:"机械工程学院", lv:"国家级",
   st:"已结束 · 我校获全国一等奖", date:"2026-07-24", tag:"mech", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】机械创新设计类的全国性赛事，学校学子获一等奖。这类赛事通常本科组占多数，研究生组队需要确认参赛资格。",
  ...
  {n:"[喜讯]我院学子斩获全国大学生机器人大赛ROBOCON赛事全国一等奖", org:"机械工程学院", lv:"国家级",
   st:"已结束 · 我校获全国一等奖", date:"2026-07-18", tag:"mech", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】机器人对抗类赛事，学校参赛队获全国一等奖。",
  ...
  {n:"[喜讯]学校学子在2026中国汽车工程学会巴哈大赛中斩获二等奖", org:"学校（校级组队）", lv:"国家级",
   st:"已结束 · 我校获全国二等奖", date:"2026-09-05", tag:"mech", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】巴哈大赛（Baja）是越野车设计制造类的全国赛事，学校学子斩获二等奖。",
  ...
  {n:"[喜讯]学校团队在第二届全国青少年智能无人系统应用大赛总决赛中荣获二等奖", org:"学校（校级组队）", lv:"国家级",
   st:"已结束 · 我校获全国二等奖", date:"2026-09-18", tag:"oth", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】面向青少年的智能无人系统应用类赛事，学校团队获总决赛二等奖。",
  ...
  {n:"[喜讯]学校学子在第18届全国大学生广告艺术大赛总决赛中斩获一等奖2项", org:"学校（校级组队）", lv:"国家级",
   st:"已结束 · 我校获全国一等奖 2 项", date:"2026-09-07", tag:"oth", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】全国大学生广告类的顶级赛事，学校学子在总决赛中斩获一等奖 2 项。",
   todo:"赛类别（平面、视频、策划案等）与命题见大赛官网。",
   help:"我能帮你：① 把平面/视频类作品的策划案写成能打的格式；② 文案和排版建议我都能出。",
   url:"https://www.cqut.edu.cn/info/1263/71871.htm"},

  {n:"[喜讯]学校参赛团队在第十三届大学生新一代信息通信科技大赛中荣获三等奖", org:"学校（校级组队）", lv:"国家级",
   st:"已结束 · 我校获全国三等奖", date:"2026-09-07", tag:"info", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】信息通信类全国性赛事，学校参赛团队获三等奖。",
   todo:"赛道与命题见大赛官网。",
   help:"我能帮你：① 扒往届获奖作品的题目方向；② 帮你把技术方案部分写成能直接交的格式。",
   url:"https://www.cqut.edu.cn/info/1263/71868.htm"},

  {n:"[喜讯]学校在第四届全国大学生通信系统设计大赛西部赛区中斩获佳绩", org:"学校（校级组队）", lv:"国家级",
   st:"已结束 · 西部赛区出成绩", date:"2026-09-07", tag:"info", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】通信系统设计类赛事，学校在西部赛区斩获佳绩。",
   todo:"赛题与赛制见大赛官网。",
   help:"我能帮你：① 找西部赛区往年的赛题和获奖方案；② 帮你把系统设计文档的框架搭出来。",
   url:"https://www.cqut.edu.cn/info/1263/71867.htm"},

  {n:"[喜讯]学校学子在全国大学生社会保障案例大赛中荣获一等奖", org:"学校（校级组队）", lv:"国家级",
   st:"已结束 · 我校获全国一等奖", date:"2026-08-30", tag:"oth", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】社会保障与公共政策方向的案例赛事，学校学子获一等奖。",
   todo:"案例选题、数据要求与评审标准见大赛官网。",
   help:"我能帮你：① 找往届一等奖案例的分析框架；② 帮你把案例正文的政策分析部分写成结构清楚的样子。",
   url:"https://www.cqut.edu.cn/info/1263/71726.htm"},

  {n:"[喜讯]学校参赛团队在第十七届中国大学生服务外包创新创业大赛中荣获二三等奖", org:"学校（校级组队）", lv:"国家级",
   st:"已结束 · 我校获全国二、三等奖", date:"2026-08-28", tag:"oth", fit:0,
   intro:"【本条是获奖结果报道，不是报名入口】服务外包与创新创业类全国赛事，学校参赛团队获二、三等奖。",
   todo:"企业命题与商务方案要求见大赛官网。",
   help:"我能帮你：① 扒往届获奖的商业计划书结构；② 帮你做一份竞品分析和财务测算的模板。",
   url:"https://www.cqut.edu.cn/info/1263/71717.htm"},

  /* ===== 正在举办的赛事（真实在办，不是获奖报道） ===== */
  {n:"关于举办 2026 年“天翼 AI”杯重庆高校人工智能大赛（重庆理工大学赛区）的通知", org:"学校（教务处 · 网络信息中心）", lv:"省部级 / 市级",
   st:"正在举办 · 学校赛区", date:"2026-09-24", tag:"oth", fit:0,
   intro:"【注意：这条是正在举办的赛事，不是获奖报道】学校联合中国电信股份有限公司重庆分公司，依托“智小理”智能体平台举办，面向全校师生，主题是把 AI 落到校园管理、教育教学、科研攻关等场景。学校通知栏 9 月共两条真·报名赛事，这是其中之一（另一条是逐梦杯足球赛）。",
   todo:"由学校教务处与网络信息中心牵头组织，各学院推荐选手参加。具体报名口径、赛道设置、提交材料与时间节点以源通知正文为准，务必点开源地址把通知读完。",
   help:"这条偏应用型（AI + 业务场景），跟你化工科研主线不是一条道，但攒一次正式参赛经历、拿一个市级奖项是现成机会。我能帮你：① 把通知正文拆成「报名对象 / 赛道 / 时间节点 / 要交什么」四张表；② 帮你把材料改成符合评审口径的申报稿。",
   url:"https://www.cqut.edu.cn/2025clnr.jsp?urltype=news.NewsContentUrl&wbtreeid=1101&wbnewsid=72172"},
